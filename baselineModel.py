...
X_train, y_train, X_val, y_val, X_test = utils.gen_dataset(1, sampleProp=100, downsample=10, freqs=None, coh=False)
...
utils.fit_eval_model(model, Name='baseline', downsample=10)
